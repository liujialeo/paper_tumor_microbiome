...
subtype_in_fig4 <-  c("CHOL_high","CHOL_low", "COAD_high","COAD_low","ESCA_high","ESCA_low","LIHC_high","LIHC_low", "PAAD_high","PAAD_low","STAD_high",   "STAD_low"  
...
ggsave(filename = "RAS_alteration.pdf", 
       width = 12, 
       height = 10)
```
